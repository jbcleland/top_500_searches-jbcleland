...
4. Sort the data by `column D` (Query Count).    
    a. When did the maximum query count occur?   Sept 2109
    b. What was the Query Text?  test
    c. What do you notice about the top 5 searches? 2018-2019 and were 4 distinct items 
...
16. Sort by the largest to smallest Year as your first level, Month Num largest to smallest as your second value, and Query Text A-Z as your third level. Scroll through to find how many times “fairgrounds” was searched in July 2018.   7
